        ...
        private void UpdateInterface()
        {
            ...
            switch (Class)
            {
                ...
                case MirClass.碧血战士:
                    WarriorButton.Index = 2427;
                    Description.Text = WarriorDescription;
                    CharacterDisplay.Index = (byte)Gender == 0 ? 220 : 500; //220 : 500;
                    break;
                case MirClass.虹玄法师:
                    WizardButton.Index = 2430;
                    Description.Text = WizardDescription;
                    CharacterDisplay.Index = (byte)Gender == 0 ? 240 : 520; //240 : 520;
                    break;
                case MirClass.翊仙道士:
                    TaoistButton.Index = 2433;
                    Description.Text = TaoistDescription;
                    CharacterDisplay.Index = (byte)Gender == 0 ? 260 : 540; //260 : 540;
                    break;
                case MirClass.飞燕刺客:
                    AssassinButton.Index = 2436;
                    Description.Text = AssassinDescription;
                    CharacterDisplay.Index = (byte)Gender == 0 ? 280 : 560; //280 : 560;
                    break;
                case MirClass.暗鬼弓手:
                    ArcherButton.Index = 2439;
                    Description.Text = ArcherDescription;
                    CharacterDisplay.Index = (byte)Gender == 0 ? 160 : 180; //160 : 180;
                    break;
            }
