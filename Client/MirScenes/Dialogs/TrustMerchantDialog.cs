...
namespace Client.MirScenes.Dialogs
{
    public sealed class TrustMerchantDialog : MirImageControl
    {
        ...
        {
            var all = new Filter { Index = 0, Title = "Show All Items", Type = ItemType.无 };
            var weapon = new Filter { Index = 1, Title = "Weapon Items", Type = ItemType.武器 };
            ...
            drapery.SubFilters.Add(new Filter { Index = 201, Title = "Armour", Type = ItemType.护甲 });
            drapery.SubFilters.Add(new Filter { Index = 202, Title = "Helmet", Type = ItemType.头盔 });
            drapery.SubFilters.Add(new Filter { Index = 203, Title = "Belt", Type = ItemType.腰带 });
            drapery.SubFilters.Add(new Filter { Index = 204, Title = "Boots", Type = ItemType.鞋 });
            drapery.SubFilters.Add(new Filter { Index = 205, Title = "Stone", Type = ItemType.守护石 });

            accessory.SubFilters.Add(new Filter { Index = 301, Title = "Necklaces", Type = ItemType.项链 });
            accessory.SubFilters.Add(new Filter { Index = 302, Title = "Bracelets", Type = ItemType.手镯 });
            accessory.SubFilters.Add(new Filter { Index = 303, Title = "Rings", Type = ItemType.戒指 });

            consumable.SubFilters.Add(new Filter { Index = 401, Title = "Recovery Pots", Type = ItemType.药剂, MaxShape = 2 });
            consumable.SubFilters.Add(new Filter { Index = 402, Title = "Buff Pots", Type = ItemType.药剂, MinShape = 3, MaxShape = 4 });
            consumable.SubFilters.Add(new Filter { Index = 403, Title = "Scrolls / Oils", Type = ItemType.卷轴 });
            consumable.SubFilters.Add(new Filter { Index = 404, Title = "Misc Items", Type = ItemType.脚本 });

            enhancement.SubFilters.Add(new Filter { Index = 501, Title = "Gems", Type = ItemType.药剂, MinShape = 3, MaxShape = 3 });
            enhancement.SubFilters.Add(new Filter { Index = 502, Title = "Orbs", Type = ItemType.药剂, MinShape = 4, MaxShape = 4 });

            book.SubFilters.Add(new Filter { Index = 601, Title = "Warrior", Type = ItemType.书籍, MaxShape = 30 });
            book.SubFilters.Add(new Filter { Index = 602, Title = "Wizard", Type = ItemType.书籍, MinShape = 31, MaxShape = 60 });
            book.SubFilters.Add(new Filter { Index = 603, Title = "Taoist", Type = ItemType.书籍, MinShape = 61, MaxShape = 90 });
            book.SubFilters.Add(new Filter { Index = 604, Title = "Assassin", Type = ItemType.书籍, MinShape = 91, MaxShape = 120 });
            book.SubFilters.Add(new Filter { Index = 605, Title = "Archer", Type = ItemType.书籍, MinShape = 121, MaxShape = 150 });

            crafting.SubFilters.Add(new Filter { Index = 701, Title = "Materials", Type = ItemType.合成材料 });
            crafting.SubFilters.Add(new Filter { Index = 703, Title = "Meat", Type = ItemType.肉 });
            crafting.SubFilters.Add(new Filter { Index = 704, Title = "Ore", Type = ItemType.矿物 });
        }
        ...
        public class Filter
        {
            ...
            public ItemType? Type { get; set; } = ItemType.无;
