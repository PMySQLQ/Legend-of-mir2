...
namespace Client
{
    ...
    public class KeyBindSettings
    {
        ...
        public void New(List<KeyBind> list)
        {
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "Toggle", Description = "定位传送", function = KeybindOptions.PositionMoves, RequireAlt = 0, RequireShift = 0, RequireTilde = 0, RequireCtrl = 1, Key = Keys.W };
            list.Add(InputKey);
        }
