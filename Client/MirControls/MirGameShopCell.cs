...
namespace Client.MirControls
{
    public sealed class GameShopCell : MirImageControl
    {
        ...
        public void UpdateText()
        {
            ...
            if (Item.Info.Type == ItemType.坐骑 || Item.Info.Type == ItemType.武器 || Item.Info.Type == ItemType.护甲 || Item.Info.Type == ItemType.变身)
            {
    ...
    public sealed class GameShopViewer : MirImageControl
    {
        ...
        public void UpdateViewer()
        {
            ...
            if (ViewerItem.Info.Type == ItemType.变身) DrawTransform();
        }
