    ...
    public partial class MagicInfoForm : Form
    {
        ...
        private void UpdateMagicForm(byte field = 0)
        {
             ...
             else
             {
                 ...
                 lblDamageExample.Text =
                             $"伤害 @ 技能等级 0: {GetMinPower(0):000}-{GetMaxPower(0):000}   |||   等级 1: {GetMinPower(1):000}-{GetMaxPower(1):000}   |||   等级 2: {GetMinPower(2):000}-{GetMaxPower(2):000}   |||   等级 3: {GetMinPower(3):000}-{GetMaxPower(3):000} |||  等级 4: {GetMinPower(4):000}-{GetMaxPower(4):000}";
                 lblDamageExplained.Text =
