...
namespace Server
{
    public partial class MapInfoForm : Form
    {
        ...
        private void UpdateInterface()
        {
            ...
            NoPositionMoveCheckbox.Checked = mi.NoPositionMove;
            for (int i = 1; i < _selectedMapInfos.Count; i++)
            {
                ...
                if (NoPositionMoveCheckbox.Checked != mi.NoPositionMove) NoPositionMoveCheckbox.Checked = false;
            }
        ...
        private String PrintMapAttributes(MapInfo map)
        {
            ...
            if (map.NoPositionMove) textOut += " NoPositionMove";
            return textOut;
        }
        ...
        private void NoPositionMoveCheckbox_CheckedChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;

            for (int i = 0; i < _selectedMapInfos.Count; i++)
                _selectedMapInfos[i].NoPositionMove = NoPositionMoveCheckbox.Checked;
        }
