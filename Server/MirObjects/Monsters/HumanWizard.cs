...
namespace Server.MirObjects.Monsters
{
    public class HumanWizard : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            Broadcast(new S.ObjectMagic { ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.雷电术, TargetID = Target.ObjectID, Target = Target.CurrentLocation, Cast = true, Level = 3 });
