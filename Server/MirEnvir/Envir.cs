...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        public List<RankCharacterInfo>[] RankClass = new List<RankCharacterInfo>[10];
        ...
        {
            //Warrior
            if (!MagicExists(Spell.基本剑术)) MagicInfoList.Add(new MagicInfo { Name = "Fencing", Spell = Spell.基本剑术, Icon = 2, Level1 = 7, Level2 = 9, Level3 = 12, Need1 = 270, Need2 = 600, Need3 = 1300, Range = 0 });
            if (!MagicExists(Spell.攻杀剑术)) MagicInfoList.Add(new MagicInfo { Name = "Slaying", Spell = Spell.攻杀剑术, Icon = 6, Level1 = 15, Level2 = 17, Level3 = 20, Need1 = 500, Need2 = 1100, Need3 = 1800, Range = 0 });
            if (!MagicExists(Spell.刺杀剑术)) MagicInfoList.Add(new MagicInfo { Name = "Thrusting", Spell = Spell.刺杀剑术, Icon = 11, Level1 = 22, Level2 = 24, Level3 = 27, Need1 = 2000, Need2 = 3500, Need3 = 6000, Range = 0, MultiplierBase = 0.25f, MultiplierBonus = 0.25f });
            if (!MagicExists(Spell.半月弯刀)) MagicInfoList.Add(new MagicInfo { Name = "HalfMoon", Spell = Spell.半月弯刀, Icon = 24, Level1 = 26, Level2 = 28, Level3 = 31, Need1 = 5000, Need2 = 8000, Need3 = 14000, BaseCost = 3, Range = 0, MultiplierBase = 0.3f, MultiplierBonus = 0.1f });
            if (!MagicExists(Spell.野蛮冲撞)) MagicInfoList.Add(new MagicInfo { Name = "ShoulderDash", Spell = Spell.野蛮冲撞, Icon = 26, Level1 = 30, Level2 = 32, Level3 = 34, Need1 = 3000, Need2 = 4000, Need3 = 6000, BaseCost = 4, LevelCost = 4, DelayBase = 2500, Range = 0, MPowerBase = 4 });
            if (!MagicExists(Spell.双龙斩)) MagicInfoList.Add(new MagicInfo { Name = "TwinDrakeBlade", Spell = Spell.双龙斩, Icon = 37, Level1 = 32, Level2 = 34, Level3 = 37, Need1 = 4000, Need2 = 6000, Need3 = 10000, BaseCost = 10, Range = 0, MultiplierBase = 0.8f, MultiplierBonus = 0.1f });
            if (!MagicExists(Spell.捕绳剑)) MagicInfoList.Add(new MagicInfo { Name = "Entrapment", Spell = Spell.捕绳剑, Icon = 46, Level1 = 32, Level2 = 35, Level3 = 37, Need1 = 2000, Need2 = 3500, Need3 = 5500, BaseCost = 15, LevelCost = 3, Range = 9 });
            if (!MagicExists(Spell.烈火剑法)) MagicInfoList.Add(new MagicInfo { Name = "FlamingSword", Spell = Spell.烈火剑法, Icon = 25, Level1 = 35, Level2 = 37, Level3 = 40, Need1 = 2000, Need2 = 4000, Need3 = 6000, BaseCost = 7, Range = 0, MultiplierBase = 1.4f, MultiplierBonus = 0.4f });
            if (!MagicExists(Spell.狮子吼)) MagicInfoList.Add(new MagicInfo { Name = "LionRoar", Spell = Spell.狮子吼, Icon = 42, Level1 = 36, Level2 = 39, Level3 = 41, Need1 = 5000, Need2 = 8000, Need3 = 12000, BaseCost = 14, LevelCost = 4, Range = 0 });
            if (!MagicExists(Spell.狂风斩)) MagicInfoList.Add(new MagicInfo { Name = "CrossHalfMoon", Spell = Spell.狂风斩, Icon = 33, Level1 = 38, Level2 = 40, Level3 = 42, Need1 = 7000, Need2 = 11000, Need3 = 16000, BaseCost = 6, Range = 0, MultiplierBase = 0.4f, MultiplierBonus = 0.1f });
            if (!MagicExists(Spell.空破闪)) MagicInfoList.Add(new MagicInfo { Name = "BladeAvalanche", Spell = Spell.空破闪, Icon = 43, Level1 = 38, Level2 = 41, Level3 = 43, Need1 = 5000, Need2 = 8000, Need3 = 12000, BaseCost = 14, LevelCost = 4, Range = 0, MultiplierBonus = 0.3f });
            if (!MagicExists(Spell.护身气幕)) MagicInfoList.Add(new MagicInfo { Name = "ProtectionField", Spell = Spell.护身气幕, Icon = 50, Level1 = 39, Level2 = 42, Level3 = 45, Need1 = 6000, Need2 = 12000, Need3 = 18000, BaseCost = 23, LevelCost = 6, Range = 0 });
            if (!MagicExists(Spell.剑气爆)) MagicInfoList.Add(new MagicInfo { Name = "Rage", Spell = Spell.剑气爆, Icon = 49, Level1 = 44, Level2 = 47, Level3 = 50, Need1 = 8000, Need2 = 14000, Need3 = 20000, BaseCost = 20, LevelCost = 5, Range = 0 });
            if (!MagicExists(Spell.天务)) MagicInfoList.Add(new MagicInfo { Name = "CounterAttack", Spell = Spell.天务, Icon = 72, Level1 = 47, Level2 = 51, Level3 = 55, Need1 = 7000, Need2 = 11000, Need3 = 15000, BaseCost = 12, LevelCost = 4, DelayBase = 24000, Range = 0, MultiplierBonus = 0.4f });
            if (!MagicExists(Spell.日闪)) MagicInfoList.Add(new MagicInfo { Name = "SlashingBurst", Spell = Spell.日闪, Icon = 55, Level1 = 50, Level2 = 53, Level3 = 56, Need1 = 10000, Need2 = 16000, Need3 = 24000, BaseCost = 25, LevelCost = 4, MPowerBase = 1, PowerBase = 3, DelayBase = 14000, DelayReduction = 4000, Range = 0, MultiplierBase = 3.25f, MultiplierBonus = 0.25f });
            if (!MagicExists(Spell.血龙剑法)) MagicInfoList.Add(new MagicInfo { Name = "Fury", Spell = Spell.血龙剑法, Icon = 76, Level1 = 45, Level2 = 48, Level3 = 51, Need1 = 8000, Need2 = 14000, Need3 = 20000, BaseCost = 10, LevelCost = 4, DelayBase = 600000, DelayReduction = 120000, Range = 0 });
            if (!MagicExists(Spell.金刚不坏)) MagicInfoList.Add(new MagicInfo { Name = "ImmortalSkin", Spell = Spell.金刚不坏, Icon = 80, Level1 = 60, Level2 = 61, Level3 = 62, Need1 = 1560, Need2 = 2200, Need3 = 3000, BaseCost = 10, LevelCost = 4, DelayBase = 600000, DelayReduction = 120000, Range = 0 });
            ...
            if (!MagicExists(Spell.抗拒火环)) MagicInfoList.Add(new MagicInfo { Name = "Repulsion", Spell = Spell.抗拒火环, Icon = 7, Level1 = 12, Level2 = 15, Level3 = 19, Need1 = 500, Need2 = 1300, Need3 = 2200, BaseCost = 2, LevelCost = 2, Range = 0, MPowerBase = 4 });
            if (!MagicExists(Spell.诱惑之光)) MagicInfoList.Add(new MagicInfo { Name = "ElectricShock", Spell = Spell.诱惑之光, Icon = 19, Level1 = 13, Level2 = 18, Level3 = 24, Need1 = 530, Need2 = 1100, Need3 = 2200, BaseCost = 3, LevelCost = 1, Range = 9 });
            if (!MagicExists(Spell.大火球)) MagicInfoList.Add(new MagicInfo { Name = "GreatFireBall", Spell = Spell.大火球, Icon = 4, Level1 = 15, Level2 = 18, Level3 = 21, Need1 = 2000, Need2 = 2700, Need3 = 3500, BaseCost = 5, LevelCost = 1, MPowerBase = 6, PowerBase = 10, Range = 9 });
            if (!MagicExists(Spell.地狱火)) MagicInfoList.Add(new MagicInfo { Name = "HellFire", Spell = Spell.地狱火, Icon = 8, Level1 = 16, Level2 = 20, Level3 = 24, Need1 = 700, Need2 = 2700, Need3 = 3500, BaseCost = 10, LevelCost = 3, MPowerBase = 14, PowerBase = 6, Range = 0 });
            if (!MagicExists(Spell.雷电术)) MagicInfoList.Add(new MagicInfo { Name = "ThunderBolt", Spell = Spell.雷电术, Icon = 10, Level1 = 17, Level2 = 20, Level3 = 23, Need1 = 500, Need2 = 2000, Need3 = 3500, BaseCost = 9, LevelCost = 2, MPowerBase = 8, MPowerBonus = 20, PowerBase = 9, Range = 9 });
            if (!MagicExists(Spell.瞬息移动)) MagicInfoList.Add(new MagicInfo { Name = "Teleport", Spell = Spell.瞬息移动, Icon = 20, Level1 = 19, Level2 = 22, Level3 = 25, Need1 = 350, Need2 = 1000, Need3 = 2000, BaseCost = 10, LevelCost = 3, Range = 0 });
            if (!MagicExists(Spell.瞬息移动)) MagicInfoList.Add(new MagicInfo { Name = "FireBang", Spell = Spell.瞬息移动, Icon = 22, Level1 = 22, Level2 = 25, Level3 = 28, Need1 = 3000, Need2 = 5000, Need3 = 10000, BaseCost = 14, LevelCost = 4, MPowerBase = 8, PowerBase = 8, Range = 9 });
            if (!MagicExists(Spell.火墙)) MagicInfoList.Add(new MagicInfo { Name = "FireWall", Spell = Spell.火墙, Icon = 21, Level1 = 24, Level2 = 28, Level3 = 33, Need1 = 4000, Need2 = 10000, Need3 = 20000, BaseCost = 30, LevelCost = 5, MPowerBase = 3, PowerBase = 3, Range = 9 });
            if (!MagicExists(Spell.疾光电影)) MagicInfoList.Add(new MagicInfo { Name = "Lightning", Spell = Spell.疾光电影, Icon = 9, Level1 = 26, Level2 = 29, Level3 = 32, Need1 = 3000, Need2 = 6000, Need3 = 12000, BaseCost = 38, LevelCost = 7, MPowerBase = 12, PowerBase = 12, Range = 0 });
            if (!MagicExists(Spell.寒冰掌)) MagicInfoList.Add(new MagicInfo { Name = "FrostCrunch", Spell = Spell.寒冰掌, Icon = 38, Level1 = 28, Level2 = 30, Level3 = 33, Need1 = 3000, Need2 = 5000, Need3 = 8000, BaseCost = 15, LevelCost = 3, MPowerBase = 12, PowerBase = 12, Range = 9 });
            if (!MagicExists(Spell.地狱雷光)) MagicInfoList.Add(new MagicInfo { Name = "ThunderStorm", Spell = Spell.地狱雷光, Icon = 23, Level1 = 30, Level2 = 32, Level3 = 34, Need1 = 4000, Need2 = 8000, Need3 = 12000, BaseCost = 29, LevelCost = 9, MPowerBase = 10, MPowerBonus = 20, PowerBase = 10, PowerBonus = 20, Range = 0 });
            if (!MagicExists(Spell.魔法盾)) MagicInfoList.Add(new MagicInfo { Name = "MagicShield", Spell = Spell.魔法盾, Icon = 30, Level1 = 31, Level2 = 34, Level3 = 38, Need1 = 3000, Need2 = 7000, Need3 = 10000, BaseCost = 35, LevelCost = 5, Range = 0 });
            if (!MagicExists(Spell.圣言术)) MagicInfoList.Add(new MagicInfo { Name = "TurnUndead", Spell = Spell.圣言术, Icon = 31, Level1 = 32, Level2 = 35, Level3 = 39, Need1 = 3000, Need2 = 7000, Need3 = 10000, BaseCost = 52, LevelCost = 13, Range = 9 });
            if (!MagicExists(Spell.噬血术)) MagicInfoList.Add(new MagicInfo { Name = "Vampirism", Spell = Spell.噬血术, Icon = 47, Level1 = 33, Level2 = 36, Level3 = 40, Need1 = 3000, Need2 = 5000, Need3 = 8000, BaseCost = 26, LevelCost = 13, MPowerBase = 12, PowerBase = 12, Range = 9 });
            if (!MagicExists(Spell.冰咆哮)) MagicInfoList.Add(new MagicInfo { Name = "IceStorm", Spell = Spell.冰咆哮, Icon = 32, Level1 = 35, Level2 = 37, Level3 = 40, Need1 = 4000, Need2 = 8000, Need3 = 12000, BaseCost = 33, LevelCost = 3, MPowerBase = 12, PowerBase = 14, Range = 9 });
            if (!MagicExists(Spell.灭天火)) MagicInfoList.Add(new MagicInfo { Name = "FlameDisruptor", Spell = Spell.灭天火, Icon = 34, Level1 = 38, Level2 = 40, Level3 = 42, Need1 = 5000, Need2 = 9000, Need3 = 14000, BaseCost = 28, LevelCost = 3, MPowerBase = 15, MPowerBonus = 20, PowerBase = 9, Range = 9 });
            if (!MagicExists(Spell.分身术)) MagicInfoList.Add(new MagicInfo { Name = "Mirroring", Spell = Spell.分身术, Icon = 41, Level1 = 41, Level2 = 43, Level3 = 45, Need1 = 6000, Need2 = 11000, Need3 = 16000, BaseCost = 21, Range = 0 });
            ...
            //Taoist
            if (!MagicExists(Spell.治愈术)) MagicInfoList.Add(new MagicInfo { Name = "Healing", Spell = Spell.治愈术, Icon = 1, Level1 = 7, Level2 = 11, Level3 = 14, Need1 = 150, Need2 = 350, Need3 = 700, BaseCost = 3, LevelCost = 2, MPowerBase = 14, Range = 9 });
            if (!MagicExists(Spell.精神力战法)) MagicInfoList.Add(new MagicInfo { Name = "SpiritSword", Spell = Spell.精神力战法, Icon = 3, Level1 = 9, Level2 = 12, Level3 = 15, Need1 = 350, Need2 = 1300, Need3 = 2700, Range = 0 });
            if (!MagicExists(Spell.施毒术)) MagicInfoList.Add(new MagicInfo { Name = "Poisoning", Spell = Spell.施毒术, Icon = 5, Level1 = 14, Level2 = 17, Level3 = 20, Need1 = 700, Need2 = 1300, Need3 = 2700, BaseCost = 2, LevelCost = 1, Range = 9 });
            if (!MagicExists(Spell.灵魂火符)) MagicInfoList.Add(new MagicInfo { Name = "SoulFireBall", Spell = Spell.灵魂火符, Icon = 12, Level1 = 18, Level2 = 21, Level3 = 24, Need1 = 1300, Need2 = 2700, Need3 = 4000, BaseCost = 3, LevelCost = 1, MPowerBase = 8, PowerBase = 3, Range = 9 });
            if (!MagicExists(Spell.召唤骷髅)) MagicInfoList.Add(new MagicInfo { Name = "SummonSkeleton", Spell = Spell.召唤骷髅, Icon = 16, Level1 = 19, Level2 = 22, Level3 = 26, Need1 = 1000, Need2 = 2000, Need3 = 3500, BaseCost = 12, LevelCost = 4, Range = 0 });
            if (!MagicExists(Spell.隐身术)) MagicInfoList.Add(new MagicInfo { Name = "Hiding", Spell = Spell.隐身术, Icon = 17, Level1 = 20, Level2 = 23, Level3 = 26, Need1 = 1300, Need2 = 2700, Need3 = 5300, BaseCost = 1, LevelCost = 1, Range = 0 });
            if (!MagicExists(Spell.集体隐身术)) MagicInfoList.Add(new MagicInfo { Name = "MassHiding", Spell = Spell.集体隐身术, Icon = 18, Level1 = 21, Level2 = 25, Level3 = 29, Need1 = 1300, Need2 = 2700, Need3 = 5300, BaseCost = 2, LevelCost = 2, Range = 9 });
            if (!MagicExists(Spell.幽灵盾)) MagicInfoList.Add(new MagicInfo { Name = "SoulShield", Spell = Spell.幽灵盾, Icon = 13, Level1 = 22, Level2 = 24, Level3 = 26, Need1 = 2000, Need2 = 3500, Need3 = 7000, BaseCost = 2, LevelCost = 2, Range = 9 });
            if (!MagicExists(Spell.心灵启示)) MagicInfoList.Add(new MagicInfo { Name = "Revelation", Spell = Spell.心灵启示, Icon = 27, Level1 = 23, Level2 = 25, Level3 = 28, Need1 = 1500, Need2 = 2500, Need3 = 4000, BaseCost = 4, LevelCost = 4, Range = 9 });
            if (!MagicExists(Spell.神圣战甲术)) MagicInfoList.Add(new MagicInfo { Name = "BlessedArmour", Spell = Spell.神圣战甲术, Icon = 14, Level1 = 25, Level2 = 27, Level3 = 29, Need1 = 4000, Need2 = 6000, Need3 = 10000, BaseCost = 2, LevelCost = 2, Range = 9 });
            if (!MagicExists(Spell.气功波)) MagicInfoList.Add(new MagicInfo { Name = "EnergyRepulsor", Spell = Spell.气功波, Icon = 36, Level1 = 27, Level2 = 29, Level3 = 31, Need1 = 1800, Need2 = 2400, Need3 = 3200, BaseCost = 2, LevelCost = 2, Range = 0, MPowerBase = 4 });
            if (!MagicExists(Spell.困魔咒)) MagicInfoList.Add(new MagicInfo { Name = "TrapHexagon", Spell = Spell.困魔咒, Icon = 15, Level1 = 28, Level2 = 30, Level3 = 32, Need1 = 2500, Need2 = 5000, Need3 = 10000, BaseCost = 7, LevelCost = 3, Range = 9 });
            if (!MagicExists(Spell.净化术)) MagicInfoList.Add(new MagicInfo { Name = "Purification", Spell = Spell.净化术, Icon = 39, Level1 = 30, Level2 = 32, Level3 = 35, Need1 = 3000, Need2 = 5000, Need3 = 8000, BaseCost = 14, LevelCost = 2, Range = 9 });
            if (!MagicExists(Spell.群体治疗术)) MagicInfoList.Add(new MagicInfo { Name = "MassHealing", Spell = Spell.群体治疗术, Icon = 28, Level1 = 31, Level2 = 33, Level3 = 36, Need1 = 2000, Need2 = 4000, Need3 = 8000, BaseCost = 28, LevelCost = 3, MPowerBase = 10, PowerBase = 4, Range = 9 });
            if (!MagicExists(Spell.迷魂术)) MagicInfoList.Add(new MagicInfo { Name = "Hallucination", Spell = Spell.迷魂术, Icon = 48, Level1 = 31, Level2 = 34, Level3 = 36, Need1 = 4000, Need2 = 6000, Need3 = 9000, BaseCost = 22, LevelCost = 10, Range = 9 });
            if (!MagicExists(Spell.无极真气)) MagicInfoList.Add(new MagicInfo { Name = "UltimateEnchancer", Spell = Spell.无极真气, Icon = 35, Level1 = 33, Level2 = 35, Level3 = 38, Need1 = 5000, Need2 = 7000, Need3 = 10000, BaseCost = 28, LevelCost = 4, Range = 9 });
            if (!MagicExists(Spell.召唤神兽)) MagicInfoList.Add(new MagicInfo { Name = "SummonShinsu", Spell = Spell.召唤神兽, Icon = 29, Level1 = 35, Level2 = 37, Level3 = 40, Need1 = 2000, Need2 = 4000, Need3 = 6000, BaseCost = 28, LevelCost = 4, Range = 0 });
            if (!MagicExists(Spell.苏生术)) MagicInfoList.Add(new MagicInfo { Name = "Reincarnation", Spell = Spell.苏生术, Icon = 53, Level1 = 37, Level2 = 39, Level3 = 41, Need1 = 2000, Need2 = 6000, Need3 = 10000, BaseCost = 125, LevelCost = 17, Range = 9 });
            if (!MagicExists(Spell.精魂召唤术)) MagicInfoList.Add(new MagicInfo { Name = "SummonHolyDeva", Spell = Spell.精魂召唤术, Icon = 40, Level1 = 38, Level2 = 41, Level3 = 43, Need1 = 4000, Need2 = 6000, Need3 = 9000, BaseCost = 28, LevelCost = 4, Range = 0 });
            if (!MagicExists(Spell.诅咒术)) MagicInfoList.Add(new MagicInfo { Name = "Curse", Spell = Spell.诅咒术, Icon = 45, Level1 = 40, Level2 = 42, Level3 = 44, Need1 = 4000, Need2 = 6000, Need3 = 9000, BaseCost = 17, LevelCost = 3, Range = 9, MPowerBase = 20 });
            if (!MagicExists(Spell.烦恼)) MagicInfoList.Add(new MagicInfo { Name = "Plague", Spell = Spell.烦恼, Icon = 74, Level1 = 42, Level2 = 44, Level3 = 47, Need1 = 5000, Need2 = 9000, Need3 = 13000, BaseCost = 20, LevelCost = 5, Range = 9 });
            ...
            if (!MagicExists(Spell.风剑术)) MagicInfoList.Add(new MagicInfo { Name = "DoubleSlash", Spell = Spell.风剑术, Icon = 59, Level1 = 15, Level2 = 17, Level3 = 19, Need1 = 700, Need2 = 1500, Need3 = 2200, BaseCost = 2, LevelCost = 1 });
            if (!MagicExists(Spell.体迅风)) MagicInfoList.Add(new MagicInfo { Name = "Haste", Spell = Spell.体迅风, Icon = 60, Level1 = 20, Level2 = 22, Level3 = 25, Need1 = 2000, Need2 = 3000, Need3 = 6000, BaseCost = 3, LevelCost = 2, Range = 0 });
            if (!MagicExists(Spell.拔刀术)) MagicInfoList.Add(new MagicInfo { Name = "FlashDash", Spell = Spell.拔刀术, Icon = 61, Level1 = 25, Level2 = 27, Level3 = 30, Need1 = 4000, Need2 = 7000, Need3 = 9000, BaseCost = 12, LevelCost = 2, DelayBase = 200, Range = 0 });
            if (!MagicExists(Spell.风身术)) MagicInfoList.Add(new MagicInfo { Name = "LightBody", Spell = Spell.风身术, Icon = 68, Level1 = 27, Level2 = 29, Level3 = 32, Need1 = 5000, Need2 = 7000, Need3 = 10000, BaseCost = 11, LevelCost = 2, Range = 0 });
            if (!MagicExists(Spell.迁移剑)) MagicInfoList.Add(new MagicInfo { Name = "HeavenlySword", Spell = Spell.迁移剑, Icon = 62, Level1 = 30, Level2 = 32, Level3 = 35, Need1 = 4000, Need2 = 8000, Need3 = 10000, BaseCost = 13, LevelCost = 2, MPowerBase = 8, Range = 0 });
            if (!MagicExists(Spell.烈风击)) MagicInfoList.Add(new MagicInfo { Name = "FireBurst", Spell = Spell.烈风击, Icon = 63, Level1 = 33, Level2 = 35, Level3 = 38, Need1 = 4000, Need2 = 6000, Need3 = 8000, BaseCost = 10, LevelCost = 1, Range = 0 });
            if (!MagicExists(Spell.捕缚术)) MagicInfoList.Add(new MagicInfo { Name = "Trap", Spell = Spell.捕缚术, Icon = 64, Level1 = 33, Level2 = 35, Level3 = 38, Need1 = 2000, Need2 = 4000, Need3 = 6000, BaseCost = 14, LevelCost = 2, DelayBase = 60000, DelayReduction = 15000, Range = 9 });
            if (!MagicExists(Spell.猛毒剑气)) MagicInfoList.Add(new MagicInfo { Name = "PoisonSword", Spell = Spell.猛毒剑气, Icon = 69, Level1 = 34, Level2 = 36, Level3 = 39, Need1 = 5000, Need2 = 8000, Need3 = 11000, BaseCost = 14, LevelCost = 3, Range = 0 });
            if (!MagicExists(Spell.月影术)) MagicInfoList.Add(new MagicInfo { Name = "MoonLight", Spell = Spell.月影术, Icon = 65, Level1 = 36, Level2 = 39, Level3 = 42, Need1 = 3000, Need2 = 5000, Need3 = 8000, BaseCost = 36, LevelCost = 3, Range = 0 });
            if (!MagicExists(Spell.吸气)) MagicInfoList.Add(new MagicInfo { Name = "MPEater", Spell = Spell.吸气, Icon = 66, Level1 = 38, Level2 = 41, Level3 = 44, Need1 = 5000, Need2 = 8000, Need3 = 11000, Range = 0 });
            if (!MagicExists(Spell.轻身步)) MagicInfoList.Add(new MagicInfo { Name = "SwiftFeet", Spell = Spell.轻身步, Icon = 67, Level1 = 40, Level2 = 43, Level3 = 46, Need1 = 4000, Need2 = 6000, Need3 = 9000, BaseCost = 17, LevelCost = 5, DelayBase = 210000, DelayReduction = 40000, Range = 0 });
            ...
            if (!MagicExists(Spell.月影雾)) MagicInfoList.Add(new MagicInfo { Name = "MoonMist", Spell = Spell.月影雾, Icon = 79, Level1 = 48, Level2 = 51, Level3 = 56, Need1 = 10, Need2 = 20, Need3 = 30, BaseCost = 30, LevelCost = 5, DelayBase = 20000, DelayReduction = 2000 });

            //Archer
            if (!MagicExists(Spell.必中闪)) MagicInfoList.Add(new MagicInfo { Name = "Focus", Spell = Spell.必中闪, Icon = 88, Level1 = 7, Level2 = 13, Level3 = 17, Need1 = 270, Need2 = 600, Need3 = 1300, Range = 0 });
            if (!MagicExists(Spell.天日闪)) MagicInfoList.Add(new MagicInfo { Name = "StraightShot", Spell = Spell.天日闪, Icon = 89, Level1 = 9, Level2 = 12, Level3 = 16, Need1 = 350, Need2 = 750, Need3 = 1400, BaseCost = 3, LevelCost = 2, MPowerBase = 8, PowerBase = 3, Range = 9 });
            if (!MagicExists(Spell.无我闪)) MagicInfoList.Add(new MagicInfo { Name = "DoubleShot", Spell = Spell.无我闪, Icon = 90, Level1 = 14, Level2 = 18, Level3 = 21, Need1 = 700, Need2 = 1500, Need3 = 2100, BaseCost = 3, LevelCost = 2, MPowerBase = 6, PowerBase = 2, Range = 9 });
            if (!MagicExists(Spell.爆阱)) MagicInfoList.Add(new MagicInfo { Name = "ExplosiveTrap", Spell = Spell.爆阱, Icon = 91, Level1 = 22, Level2 = 25, Level3 = 30, Need1 = 2000, Need2 = 3500, Need3 = 5000, BaseCost = 10, LevelCost = 3, MPowerBase = 15, PowerBase = 15, Range = 0 });
            if (!MagicExists(Spell.爆闪)) MagicInfoList.Add(new MagicInfo { Name = "DelayedExplosion", Spell = Spell.爆闪, Icon = 92, Level1 = 31, Level2 = 34, Level3 = 39, Need1 = 3000, Need2 = 7000, Need3 = 10000, BaseCost = 8, LevelCost = 2, MPowerBase = 30, PowerBase = 15, Range = 9 });
            if (!MagicExists(Spell.气功术)) MagicInfoList.Add(new MagicInfo { Name = "Meditation", Spell = Spell.气功术, Icon = 93, Level1 = 19, Level2 = 24, Level3 = 29, Need1 = 1800, Need2 = 2600, Need3 = 5600, BaseCost = 8, LevelCost = 2, Range = 0 });
            if (!MagicExists(Spell.万斤闪)) MagicInfoList.Add(new MagicInfo { Name = "ElementalShot", Spell = Spell.万斤闪, Icon = 94, Level1 = 20, Level2 = 25, Level3 = 31, Need1 = 1800, Need2 = 2700, Need3 = 6000, BaseCost = 8, LevelCost = 2, MPowerBase = 6, PowerBase = 3, Range = 9 });
            ...
            if (!MagicExists(Spell.毒魔闪)) MagicInfoList.Add(new MagicInfo { Name = "PoisonShot", Spell = Spell.毒魔闪, Icon = 102, Level1 = 40, Level2 = 45, Level3 = 49, Need1 = 6000, Need2 = 14000, Need3 = 16000, BaseCost = 10, LevelCost = 4, MPowerBase = 10, PowerBase = 10, Range = 9 });
            if (!MagicExists(Spell.邪爆闪)) MagicInfoList.Add(new MagicInfo { Name = "CrippleShot", Spell = Spell.邪爆闪, Icon = 103, Level1 = 43, Level2 = 47, Level3 = 50, Need1 = 12000, Need2 = 15000, Need3 = 18000, BaseCost = 15, LevelCost = 3, MPowerBase = 10, MPowerBonus = 20, PowerBase = 10, Range = 9 });
            if (!MagicExists(Spell.蛇柱阱)) MagicInfoList.Add(new MagicInfo { Name = "SummonSnakes", Spell = Spell.蛇柱阱, Icon = 104, Level1 = 46, Level2 = 51, Level3 = 54, Need1 = 14000, Need2 = 17000, Need3 = 20000, BaseCost = 10, LevelCost = 5, Range = 9 });
            if (!MagicExists(Spell.血龙闪)) MagicInfoList.Add(new MagicInfo { Name = "NapalmShot", Spell = Spell.血龙闪, Icon = 105, Level1 = 48, Level2 = 52, Level3 = 55, Need1 = 15000, Need2 = 18000, Need3 = 21000, BaseCost = 40, LevelCost = 10, MPowerBase = 25, MPowerBonus = 25, PowerBase = 25, Range = 9 });
        ...
        private void AdjustLights()
        {
            ...
            if (hours == 6 || hours == 7)
                ...
                Lights = LightSetting.半晚;
            else
                Lights = LightSetting.夜晚;
        ...
        public void NewCharacter(ClientPackets.NewCharacter p, MirConnection c, bool IsGm)
        {
            ...
            if (p.Class != MirClass.战士 && p.Class != MirClass.法师 && p.Class != MirClass.道士 &&
                p.Class != MirClass.刺客 && p.Class != MirClass.弓手)
            {
            ...
            if (p.Class == MirClass.刺客 && !Settings.AllowCreateAssassin ||
                p.Class == MirClass.弓手 && !Settings.AllowCreateArcher)
            {
                c.Enqueue(new ServerPackets.NewCharacter { Result = 3 });
                return;
            }
        ...
        public bool CanCreateHero(ClientPackets.NewHero p, MirConnection c, bool IsGm)
        {
            ...
            if (p.Class != MirClass.战士 && p.Class != MirClass.法师 && p.Class != MirClass.道士 && p.Class != MirClass.刺客 && p.Class != MirClass.弓手)
            {
                c.Enqueue(new S.NewHero { Result = 3 });
                return false;
            }

            if (p.Class == MirClass.刺客 && !Settings.AllowCreateAssassin || p.Class == MirClass.弓手 && !Settings.AllowCreateArcher)
            {
                c.Enqueue(new S.NewHero { Result = 3 });
                return false;
            }
