    ...
    public class QuestProgressInfo
    {
        ...
        public void UpdateKillTasks()
        {
            ...
            for (int i = 0; i < KillTaskCount.Count; i++)
            {
                ...
                {
                    TaskList.Add(string.Format("{0} {1}", Info.KillTasks[i].Message, KillTaskCount[i].Complete ? "(完成)" : ""));
                }
            }
        }
        ...
        public void UpdateItemTasks()
        {
            ...
            for (int i = 0; i < ItemTaskCount.Count; i++)
            {
                ...
                {
                    TaskList.Add(string.Format("{0} {1}", Info.ItemTasks[i].Message, ItemTaskCount[i].Complete ? "(完成)" : ""));
                }
            }
        }
        ...
        public void UpdateFlagTasks()
        {
            ...
            for (int i = 0; i < FlagTaskSet.Count; i++)
            {
                ...
                {
                    TaskList.Add(string.Format("激活标志 {0} {1}", Info.FlagTasks[i].Number, FlagTaskSet[i].Complete ? "(完成)" : ""));
                }
                else
                {
                    TaskList.Add(string.Format("{0} {1}", Info.FlagTasks[i].Message, FlagTaskSet[i].Complete ? "(完成)" : ""));
                }
            }
        }
