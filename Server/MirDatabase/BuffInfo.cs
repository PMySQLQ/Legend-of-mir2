    ...
    public class BuffInfo
    {
        ...
        public static List<BuffInfo> Load()
        {
            List<BuffInfo> info = new List<BuffInfo>
            {
                ...
                new BuffInfo { Type = BuffType.FastMove, Properties = BuffProperty.None, StackType = BuffStackType.ResetDuration , Visible = true},
                ...
                new BuffInfo { Type = BuffType.HumUp, Properties = BuffProperty.None, StackType = BuffStackType.Infinite }, //???
