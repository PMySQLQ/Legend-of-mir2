...
public class ItemInfo
{
    ...
    {
        get { return Type == ItemType.药剂 || Type == ItemType.卷轴 || Type == ItemType.食物 || Type == ItemType.变身 || Type == ItemType.脚本 || Type == ItemType.SealedHero; }
    }
    ...
    public ItemInfo(BinaryReader reader, int version = int.MaxValue, int customVersion = int.MaxValue)
    {
        ...
        RequiredClass = version <= 105 ? (RequiredClass)reader.ReadByte() : (RequiredClass)reader.ReadUInt16();
