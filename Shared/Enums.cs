...
public enum Monster : ushort
{
    ...
    Yob = 8,//
    Oma = 9,//半兽人
    CannibalPlant = 10,//食人花
    ForestYeti = 11,//森林雪人
    SpittingSpider = 12,//毒蜘蛛
    ChestnutTree = 13,//栗子树
    EbonyTree = 14,//乌木树
    LargeMushroom = 15,//大蘑菇
    CherryTree = 16,//樱桃树
    OmaFighter = 17,//半兽人战士
    OmaWarrior = 18,//半兽人勇士
    CaveBat = 19,//山洞蝙蝠
    ...
    Dung = 27,//粪虫
    Dark = 28,//黑暗战士
    WoomaSoldier = 29,//沃玛战士
    WoomaFighter = 30,//沃玛勇士
    WoomaWarrior = 31,//沃玛战将
    FlamingWooma = 32,//火焰沃玛
    WoomaGuardian = 33,//沃玛护卫
    WoomaTaurus = 34, //沃玛教主
    WhimperingBee = 35,//跳跳蜂
    GiantWorm = 36,//巨型蠕虫
    Centipede = 37,//蜈蚣
    BlackMaggot = 38,//黑色恶蛆
    Tongs = 39,//钳虫
    EvilTongs = 40,//邪恶钳虫
    EvilCentipede = 41,//触龙神 BOOS
    BugBat = 42,
    BugBatMaggot = 43,
    WedgeMoth = 44,
    RedBoar = 45,
    ...
    SpiderFrog = 81,//齿虫
    HoroBlaster = 82,//抱眼虫
    BlueHoroBlaster = 83,//凸眼虫
    KekTal = 84,//多脚虫
    VioletKekTal = 85,//多角虫
    Khazard = 86,//赤毒蜥蜴 BOOS
    RoninGhoul = 87,
    ToxicGhoul = 88,
    BoneCaptain = 89,
    BoneSpearman = 90,
    ...
    HellSlasher = 215,//斩怨鬼
    HellPirate = 216,//钢刀鬼
    HellCannibal = 217,//吞食鬼
    HellKeeper = 218, //BOSS 地狱守门人
    HellBolt = 219, //灭魂鬼
    WitchDoctor = 220,
    ManectricHammer = 221,
    ManectricClub = 222,
    ...
    FightingCat = 273,
    FireCat = 274, //AI 44
    CatWidow = 275, //AI 112 长枪猫卫
    StainHammerCat = 276, //白锥猫卫
    BlackHammerCat = 277, //黑锥猫卫
    StrayCat = 278, //猫妖武士
    CatShaman = 279, //灵猫法师
    Jar1 = 280,
    Jar2 = 281,
